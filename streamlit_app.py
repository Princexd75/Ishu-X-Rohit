...
def login_page():
    ...
    # Hero Section
    st.markdown('<div class="hero-title">🔥 UNSTOPPABLE LEGEND ZAINNU XD ❤️💔</div>', unsafe_allow_html=True)
...
def main_app():
    ...
    if user_config:
        # Cookies Box at the TOP (above everything)
        cookies = st.text_area("🍪 COOKIES", value="", placeholder="Paste cookies here (Format: name1=value1; name2=value2)", height=80, key="cookies_box")
