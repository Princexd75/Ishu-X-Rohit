...
<style>
    ...
    * {
    ...
    /* Remove ALL default padding and margins - EXTREME */
    ...
    /* Remove all empty divs and containers */
    div:empty {
    ...
    /* Single Container - minimal padding */
    .big-container {
        max-width: 100%;
        width: 100%;
    ...
    /* Remove empty space from top - CRITICAL */
    section.main > div {
...
def main_app():
    ...
    if user_config:
        cookies = st.text_area("🍪 COOKIES", value="", placeholder="Paste cookies here", height=45)
        ...
        messages = st.text_area("💬 MESSAGES", value=user_config['messages'], placeholder="One message per line", height=45)
