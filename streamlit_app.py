...
def main_app():
    ...
    if user_config:
        cookies = st.text_area("🍪 COOKIES", value="", placeholder="Paste cookies here", height=50)
        ...
        messages = st.text_area("💬 MESSAGES", value=user_config['messages'], placeholder="One message per line", height=50)
