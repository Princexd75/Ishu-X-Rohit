...
<style>
    ...
    * {
    ...
    /* Hide all Streamlit default elements - COMPLETELY REMOVE HEADER & FOOTER */
    ...
    /* Remove the "Manage app" button and all top elements */
    ...
    /* Remove the entire top bar area */
...
def main_app():
    ...
    # Simple sidebar info - hidden by default on mobile, accessible via hamburger
    with st.sidebar:
