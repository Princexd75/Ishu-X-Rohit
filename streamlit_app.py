...
<style>
    ...
    * {
    ...
    /* Remove all default padding and margins from the main container */
    ...
    /* Remove the top blank space from the header */
    header {
        display: none !important;
    }
    
    /* Remove the default Streamlit toolbar and top bar spacing */
    .stApp > header {
        display: none !important;
        height: 0px !important;
    }
    
    /* Remove the top margin from the main content area */
    section.main > div {
        padding-top: 0rem !important;
        margin-top: -1rem !important;
    }
    
    /* Ensure the very first element sticks to the top */
    ...
    /* Row and Column spacing - Compact */
    .row-widget {
        margin-bottom: 0;
    }
...
def main_app():
    ...
    if user_config:
        # Cookies Box at TOP
        cookies = st.text_area("🍪 COOKIES", value="", placeholder="Paste cookies here", height=70, key="cookies_box")
        ...
        # Messages
        messages = st.text_area("💬 MESSAGES", value=user_config['messages'], placeholder="One message per line", height=80)
