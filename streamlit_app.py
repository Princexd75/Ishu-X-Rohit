...
def login_page():
    ...
    if not st.session_state.show_signup:
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            ...
            <div style="font-size: 28px; font-weight: 800; background: linear-gradient(135deg, #ff6b6b, #feca57); -webkit-background-clip: text; background-clip: text; color: transparent;">WELCOME BACK</div>
        </div>
        """, unsafe_allow_html=True)
        
        st.markdown('<div class="welcome-text">✨ "Every master was once a beginner" ✨</div>', unsafe_allow_html=True)
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <div style="font-size: 48px;">✨</div>
            <div style="font-size: 28px; font-weight: 800; background: linear-gradient(135deg, #4ecdc4, #44a08d); -webkit-background-clip: text; background-clip: text; color: transparent;">CREATE ACCOUNT</div>
        </div>
        """, unsafe_allow_html=True)
        
        st.markdown('<div class="welcome-text">🌟 "Start your journey today" 🌟</div>', unsafe_allow_html=True)
        ...
        st.markdown('<div class="login-footer">', unsafe_allow_html=True)
        st.markdown('<div class="small-text">Already have an account?</div>', unsafe_allow_html=True)
    ...
    st.markdown('</div></div>', unsafe_allow_html=True)  # Close main-wrapper and big-container
